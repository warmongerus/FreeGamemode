...
/***/ "./src/scripts/views/create-char.js":
/*!******************************************!*\
  !*** ./src/scripts/views/create-char.js ***!
  \******************************************/
/*! exports provided: default */
...
function () {
  function CreateChar() {
    _classCallCheck(this, CreateChar);
      ...
      window.vm = new vue_dist_vue_common__WEBPACK_IMPORTED_MODULE_0___default.a({
        ...
        methods: {
          changeMenu: function changeMenu(index) {
            ...
            $.post("http://_creator/Changes", JSON.stringify({
              camera: this.menu1[this.selectedMenu].name
            }));
          },
          changeMenu2: function changeMenu2(index) {
            this.selectedMenu2 = index;
            $.post("http://_creator/Changes", JSON.stringify({
              camera: this.menu2[this.selectedMenu2].name
            }));
          },
          changeMenu3: function changeMenu3(index) {
            if (this.selectedMenu3 == 0) {
              if (this.validateStep()) {
                this.selectedMenu3 = index;
                $.post("http://_creator/Changes", JSON.stringify({
                  camera: this.menu3[this.selectedMenu3].name
                }));
              }
            } else {
              this.selectedMenu3 = index;
          ...
          isActive2: function isActive2(menuItem) {
            return this.selectedMenu2 === menuItem;
          },
          isActive3: function isActive3(menuItem) {
          ...
          changeAppearence: function changeAppearence(v) {
          ...
          changeStyle: function changeStyle(v) {
            if (this.selectedMenu2 == 0) {
              $.post("http://_creator/StyleChange", JSON.stringify({
                changeBrands: true,
          ...
          openCreator: function openCreator(bool) {
            this.showCreator = bool;
            this.apprChange();
          },
          eyesChange: function eyesChange() {
            $.post("http://_creator/Changes", JSON.stringify({
              changeEye: true,
          ...
          lipsChange: function lipsChange() {
            $.post("http://_creator/Changes", JSON.stringify({
              changeLips: true,
              lips: this.menu1[this.selectedMenu].options[0].value
            }));
          },
          chinChange: function chinChange() {
            $.post("http://_creator/Changes", JSON.stringify({
              changeChin: true,
          ...
          cheekChange: function cheekChange() {
            $.post("http://_creator/Changes", JSON.stringify({
              changeCheek: true,
          ...
          neckChange: function neckChange() {
            $.post("http://_creator/Changes", JSON.stringify({
              changeNeck: true,
              neckWidth: this.menu1[this.selectedMenu].options[0].value
            }));
          },
          noseChange: function noseChange() {
            $.post("http://_creator/Changes", JSON.stringify({
              changeNose: true,
          ...
          apprChange: function apprChange() {
            $.post("http://_creator/Changes", JSON.stringify({
          ...
          changeClothes: function changeClothes() {
          ...
          jacketChange: function jacketChange() {
            $.post("http://_creator/ChangeClothes", JSON.stringify({
              changeJacket: true,
              id: this.menu3[this.selectedMenu3].options[0].value,
              texture: this.menu3[this.selectedMenu3].options[1].value
            }));
          },
          shirtChange: function shirtChange() {
            $.post("http://_creator/ChangeClothes", JSON.stringify({
              changeShirt: true,
              id: this.menu3[this.selectedMenu3].options[0].value,
              texture: this.menu3[this.selectedMenu3].options[1].value
          ...
          torsoChange: function torsoChange() {
            $.post("http://_creator/ChangeClothes", JSON.stringify({
              changeTorso: true,
              id: this.menu3[this.selectedMenu3].options[0].value,
              texture: this.menu3[this.selectedMenu3].options[1].value
          ...
          legsChange: function legsChange() {
            $.post("http://_creator/ChangeClothes", JSON.stringify({
              changeLegs: true,
              id: this.menu3[this.selectedMenu3].options[0].value,
              texture: this.menu3[this.selectedMenu3].options[1].value
          ...
          shoesChange: function shoesChange() {
            $.post("http://_creator/ChangeClothes", JSON.stringify({
              changeShoes: true,
              id: this.menu3[this.selectedMenu3].options[0].value,
              texture: this.menu3[this.selectedMenu3].options[1].value
          ...
          acessoryChange: function acessoryChange() {
            $.post("http://_creator/ChangeClothes", JSON.stringify({
              changeAcessory: true,
              id: this.menu3[this.selectedMenu3].options[0].value,
              texture: this.menu3[this.selectedMenu3].options[1].value
          ...
          finishCreator: function finishCreator() {
            if (this.validateStep()) {
              $.post("http://_creator/FinishedCreator", JSON.stringify({
                charName: this.menu3[0].options[0].value,
                age: this.menu3[0].options[1].value
              }));
            }
          }
        },
...
window.addEventListener("keydown", throttle(function (ev) {
  ...
  if (_key) {
    $.post('http://_creator/rotate', JSON.stringify({
      key: _key
    }));
  }
}));
/* harmony default export */ __webpack_exports__["default"] = (CreateChar);
  ...
  _createClass(Inventory, [{
    ...
    value: function initScript() {
      window.vm = new vue_dist_vue_common__WEBPACK_IMPORTED_MODULE_0___default.a({
        ...
        methods: {
          emitItens: function emitItens(listitens) {
            this.items = null;
