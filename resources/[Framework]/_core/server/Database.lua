...
-------- CHARACTER THIGNS -----------
API_Database.prepare('CKF_/CreateCharacter', "INSERT INTO characters(user_id, characterName, age, skin, clothes, groups) VALUES (@user_id, @charName, @charAge, @charSkin, @clothes, '{\"user\":true}'); SELECT LAST_INSERT_ID() AS id")
